"""Model and tokenizer loading for MLX Forge v0.
...
def load_model(
    ...
    mlx-lm. It supports the architectures defined in the MLX Forge registry.
    ...
    Note:
        ...
        before calling this function (see mlx_forge.models.resolve).
