"""Cohere Command R+ v2 architecture for MLX Forge.
...
- Parallel attention + MLP (same as Cohere v1)
...
class ModelArgs(BaseModelArgs):
    """Cohere2 model configuration arguments."""
...
class Attention(nn.Module):
    ...
    def __init__(self, args: ModelArgs, layer_idx: int = 0):
        ...
        # Sliding window on specific layers based on pattern
...
class TransformerBlock(nn.Module):
    """Cohere2 transformer layer with parallel attention + MLP."""
...
class Model(nn.Module):
    """Cohere2 Command R+ v2 model for MLX Forge."""
