...
from mlx_forge.trainer.callbacks import CallbackList
from mlx_forge.trainer.checkpoint import CheckpointManager
from mlx_forge.trainer.optimizer import build_optimizer
...
def loss_fn(model, input_ids, labels):
    ...
    from mlx_forge.losses.sft import loss_fn as _loss_fn
...
def loss_fn_packed(model, input_ids, labels, segment_ids):
    ...
    from mlx_forge.losses.sft import loss_fn_packed as _loss_fn_packed
