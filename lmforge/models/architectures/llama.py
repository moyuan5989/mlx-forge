"""Llama model architecture for LMForge.

Supports:
- Llama 2/3 family
- Mistral (via model_type remapping)
...
class ModelArgs(BaseModelArgs):
    """Llama model configuration arguments."""
...
class LlamaModel(nn.Module):
    """Llama transformer backbone (embeddings + layers + norm)."""
...
class Model(nn.Module):
    """
    Llama model for LMForge training.
