"""FastAPI application for LMForge Studio.
...
def create_app(runs_dir: str = "~/.lmforge/runs") -> FastAPI:
...
def run_server(host: str = "127.0.0.1", port: int = 8741, runs_dir: str = "~/.lmforge/runs"):
    ...
    print(f"LMForge Studio starting on http://{host}:{port}")
