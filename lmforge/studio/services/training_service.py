...
Spawns `lmforge train` as a child process and tracks active runs.
"""
...
class TrainingService:
    ...
    async def start_training(self, config_dict: dict) -> dict:
        ...
        config_dir = Path(tempfile.mkdtemp(prefix="lmforge_studio_"))
        ...
        proc = await asyncio.create_subprocess_exec(
            python, "-m", "lmforge.cli.main", "train", "--config", str(config_path),
